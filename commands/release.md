...
3. `SEO_GUIDELINE.md` Read — SEO + GEO 체크리스트 확인 (있을 경우).
...
- [ ] JSON-LD 구조화 데이터 유효성
- [ ] `llms.txt` 존재 + 접근 가능 확인 (GEO)
- [ ] `llms-full.txt` 존재 + 접근 가능 확인 (GEO)
...
7. SEO + GEO
   ...
   — 또는 —
   ⏭️ SEO_GUIDELINE.md 미존재 — 건너뜀 (SEO + GEO 미설정)
